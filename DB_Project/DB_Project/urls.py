...
urlpatterns = [
    ...
    url(r'^tc_judge/$', t_mux.tc_judge),
    url(r'^tc_judge_do/$', tc.tc_judge_do),
    url(r'^tc_judge_solve/$', tc.tc_judge_solve),
    url(r'^tc_detail/$', t_mux.tc_detail),
    url(r'^sc_detail/$', s_mux.sc_detail),
    url(r'^hw_detail/$', t_mux.tc_hw_detail),
    url(r'^tu_judge_do/$', tutor.tu_judge_do),
    url(r'^tu_judge_daily/$', tutor.tu_judge_daily),
    url(r'^add_HW/$', tc.add_HW),
    url(r'^tu_judge_solve/$', tutor.tu_judge_solve),
